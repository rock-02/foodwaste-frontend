...
import "./delvery.css"; // Import your CSS file
import Footer from "../components/footer/Footer";

export const Delvery = () => {
        ...
        <div className="four2">
          ...
          <div className="upper2">
            {/* <div className="post2">
              ...
              <Link to="/postFood" className="feedback2" onClick={handleClick}>
            ...
            <div className="post2">
              ...
              <Link to="/orders" className="feedback2" onClick={handleClick}>
                Orders
              </Link>
            </div>
          </div>
